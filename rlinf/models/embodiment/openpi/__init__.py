...
from openpi.training.config import DataConfig, LeRobotLiberoDataConfig, AssetsConfig, DataConfigFactory, ModelTransformFactory
...
from rlinf.models.embodiment.openpi.dataconfig.libero_dataconfig import LeRobotLiberoDataConfig
from rlinf.models.embodiment.openpi.dataconfig.metaworld_dataconfig import LeRobotMetaworldDataConfig
import difflib
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotMetaworldDataConfig(
            ...
            base_config=DataConfig(
                prompt_from_task=True,
                root="data/metaworld_mt50"
            ),
            assets=AssetsConfig(
                assets_dir="checkpoints/torch/pi0_metaworld/assets"
            ),
