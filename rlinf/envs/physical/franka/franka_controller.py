...
from rlinf.envs.physical.ros import ROSController
...
class FrankaController(Worker):
    ...
    def _on_arm_jacobian_msg(self, msg: ZeroJacobian):
        ...
        """
        self._arm_jacobian = np.array(list(msg.zero_jacobian)).reshape(
            (6, 7), order="F"
        )
    ...
    def move_arm(self, position: List[float]):
        ...
        Args:
            position (List[float]): The desired position. Must be a list of 7 floats, meaning [x, y, z, qx, qy, qz, qw]
        """
