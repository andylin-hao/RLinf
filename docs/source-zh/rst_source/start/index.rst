...
在具身智能任务上，RLinf 在 **LIBERO**、**ManiSkill**、**RoboTwin** 等多个基准中达到了或接近当前最优的成功率，支持 OpenVLA、OpenVLA-OFT、π₀/π₀.₅、GR00T 等多种 VLA 模型（详见 :doc:`../examples/index` 中的示例库与 :doc:`../reference/index` 中的算法教程）。
