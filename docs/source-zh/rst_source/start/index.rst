...
在智能体任务（包含数学推理）上，RLinf 基于 DeepSeek-R1-Distill-Qwen 系列模型，在 **AIME24 / AIME25 / GPQA-diamond** 等基准上达到 SOTA 表现（详见 :doc:`../examples/agentic/reasoning` 以及 `RLinf-math-1.5B/7B <https://huggingface.co/RLinf>`_ 检查点）。
