...
For agentic tasks (including math reasoning), RLinf achieves SOTA performance on **AIME24/AIME25/GPQA-diamond** benchmarks with DeepSeek-R1-Distill-Qwen models (see :doc:`../examples/agentic/reasoning` and the `RLinf-math-1.5B/7B <https://huggingface.co/RLinf>`_ checkpoints).
