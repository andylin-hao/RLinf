...
For embodied tasks, RLinf reaches or matches SOTA success rates on benchmarks such as **LIBERO**, **ManiSkill**, **RoboTwin**, and more with OpenVLA, OpenVLA-OFT, π₀/π₀.₅, GR00T and other VLAs (see the :doc:`../examples/index` gallery and :doc:`../reference/index` for algorithm details).
