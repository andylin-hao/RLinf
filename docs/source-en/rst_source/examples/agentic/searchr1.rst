...
Run `rlinf/utils/ckpt_convertor/megatron_convertor/mg2hf_3b.sh` to convert a Megatron checkpoint into a HuggingFace model:

.. code-block:: bash

   sh rlinf/utils/ckpt_convertor/megatron_convertor/mg2hf_3b.sh {your_output_dir}/{exp_name}/checkpoints/global_step_xxx/actor {path/to/save/huggingface/model} {path/to/model/Qwen2.5-3B-Instruct}
