...
Usage::
    ...
    python3 .claude/skills/docs-check/check_doc_symbols.py           # all docs
    python3 .claude/skills/docs-check/check_doc_symbols.py FILE...   # subset
    python3 .claude/skills/docs-check/check_doc_symbols.py --allow Foo --allow Bar
