...
## 最新动态
- [2026/02] 🔥 RLinf 支持基于 [GSEnv（ManiSkill-GS）](https://github.com/chenkang455/ManiSkill-GS) 的 Real2Sim2Real 强化学习。文档：[RL with GSEnv](https://rlinf.readthedocs.io/zh-cn/latest/rst_source/examples/gsenv.html)。
