...
- Evaluation: [VLA evaluation](https://rlinf.readthedocs.io/en/latest/rst_source/start/vla-eval.html) · [LLMEvalKit](https://github.com/RLinf/LLMEvalKit)
